...
WELCOME_MESSAGE = 'Welcome to use PC-AGENT-REMOTE🛸, A UI-focused Agent for Windows OS Interaction.'
art = text2art('PC-AGENT-REMOTE')
WELCOME_TEXT = """
{art}
...
def sensitive_step_asker(action, control_text) -> bool:
    ...
    utils.print_with_color(
        "[Input Required:] PC-AGENT-REMOTE🛸 will apply {action} on the [{control_text}] item. Please confirm whether to proceed or not. Please input Y or N.".format(
