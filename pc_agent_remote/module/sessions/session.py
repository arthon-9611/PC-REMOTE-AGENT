...
from pc_agent_remote.agents.agent.app_agent import OpenAIOperatorAgent
from pc_agent_remote.agents.agent.host_agent import AgentFactory
from pc_agent_remote.agents.states.app_agent_state import ContinueAppAgentState
from pc_agent_remote.agents.states.host_agent_state import ContinueHostAgentState
from pc_agent_remote.config.config import Config
from pc_agent_remote.module import interactor
from pc_agent_remote.module.basic import BaseRound, BaseSession
from pc_agent_remote.module.context import ContextNames
from pc_agent_remote.module.sessions.plan_reader import PlanReader
from pc_agent_remote.trajectory.parser import Trajectory
from pc_agent_remote.automator.ui_control.inspector import ControlInspectorFacade
...
class Session(BaseSession):
    ...
    def __init__(
        ...
        :param request: The user request of the session, optional. If not provided, PC-AGENT-REMOTE will ask the user to input the request.
        :param mode: The mode of the task.
        """
...
class FromFileSession(BaseSession):
    """
    A session for PC-AGENT-REMOTE from files.
    """
